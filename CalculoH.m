% This function:
% - Generates position of scatterers in a cluster according to the settings
% of the scenario in file Plantilla
% - Calculates the parameters for each ray, namely AoD, AoA, delay and complex amplitude
% - Normalization and calculation of the Channel Impulse Response h(tao, AoD, AoA)
% - Calculation of channel matrix H
